...
class TokenUpdateTransaction extends _Transaction.default {
  ...
  setTokenId(tokenId) {
    ...
    this._tokenId = tokenId instanceof _TokenId.default ? tokenId : _TokenId.default.fromString(tokenId);
    return this;
  }
  /**
   * @returns {?string}
  ...
  setTreasuryAccountId(id) {
    ...
    this._treasuryAccountId = id instanceof _AccountId.default ? id : _AccountId.default.fromString(id);
    return this;
  }
  /**
   * @returns {?Key}
