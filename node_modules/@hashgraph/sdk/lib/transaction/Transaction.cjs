...
exports.default = exports.TRANSACTION_REGISTRY = exports.CHUNK_SIZE = exports.DEFAULT_RECORD_THRESHOLD = exports.DEFAULT_AUTO_RENEW_PERIOD = void 0;
...
class Transaction extends _Executable.default {
  ...
  static _fromProtobufTransactions(transaction, transactions, signedTransactions, transactionIds, nodeIds, bodies) {
    ...
    transaction._transactionValidDuration = body.transactionValidDuration != null ?
    /** @type {Long} */
    body.transactionValidDuration.seconds.toInt() : DEFAULT_TRANSACTION_VALID_DURATION;
  ...
  getTransactionHashPerNode() {
    ...
    return _TransactionHashMap.default._fromTransaction(this);
  }
  /**
   * @returns {TransactionId}
   */
