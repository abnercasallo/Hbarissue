 ...
 */
export default class Transaction extends Executable<import("@hashgraph/proto").ITransaction, import("@hashgraph/proto").ITransactionResponse, TransactionResponse> {
    /**
     ...
     */
    _transactions: proto.ITransaction[];
    /**
     * List of proto transactions that have been built from this SDK
     * transaction. Each one should share the same transaction ID.
     *
     ...
     * @internal
     */
    _buildTransactions(untilIndex: number): void;
    /**
     * @internal
